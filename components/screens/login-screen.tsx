    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(49, 105, 78, 0.15) 0%, rgba(49, 105, 78, 0.08) 40%, transparent 70%)",
          }}
        ></div>
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(49, 105, 78, 0.12) 0%, rgba(49, 105, 78, 0.06) 40%, transparent 70%)",
            animationDelay: "2s",
          }}
        ></div>
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(49, 105, 78, 0.08) 0%, rgba(49, 105, 78, 0.04) 50%, transparent 80%)",
            animationDelay: "4s",
          }}
        ></div>
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(49, 105, 78, 0.06) 0%, rgba(49, 105, 78, 0.03) 60%, transparent 90%)",
            animationDelay: "6s",
          }}
        ></div>
      </div>
      ...
      <div className="flex w-full max-w-lg flex-col items-center gap-10 relative z-10">
        ...
        <div className="flex items-center gap-4 relative">
          ...
          <span className="text-5xl tracking-tight text-primary font-logo drop-shadow-sm">
            ProMate
          </span>
        </div>
        ...
        <div className="w-full rounded-2xl border border-border/50 bg-card/80 backdrop-blur-md p-8 shadow-2xl shadow-primary/10">
          <div className="flex flex-col items-center gap-6">
            <div className="flex flex-col items-center gap-2">
              <h1
                className="text-xl text-card-foreground text-balance text-center"
                style={{ fontWeight: 600 }}
              >
                기획은 줄이고 실행은 앞당기세요
              </h1>
              <p
                className="text-sm text-muted-foreground text-center text-pretty leading-relaxed"
            ...
            <p className="text-xs text-muted-foreground/80 text-center">
              ...
              또는{" "}
              <span className="font-medium">시크릿 모드(Ctrl+Shift+N)</span>{" "}
              에서 시도해 보세요. 시크릿 모드에서 되면 브라우저 쿠키를 삭제하면
              해결됩니다.
            </p>
            <button
              type="button"
              ...
              className="text-xs text-muted-foreground/70 hover:text-foreground underline mt-1"
            >
              저장된 로그인 정보 초기화
            </button>
          </div>
